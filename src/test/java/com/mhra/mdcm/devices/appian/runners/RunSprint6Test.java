...
@CucumberOptions(
        ...
        plugin = {"pretty", "html:target/cucumber-html-report", "json:target/sprint6_tests.json", "rerun:target/failedScenarios.txt"}
        , monochrome = true, tags = {"@_sprint6,~@ignore"}
)
public class RunSprint6Test {
}
