...
@CucumberOptions(
        ...
        plugin = {"pretty", "html:target/cucumber-html-report", "json:target/sprint12_tests.json", "rerun:target/failedScenarios.txt"}
        , monochrome = true, tags = {"@_sprint12,~@ignore"}
)
public class RunSprint12Test {
}
