...
@CucumberOptions(
        ...
        plugin = {"pretty", "html:target/cucumber-html-report", "json:target/sprint13_tests.json", "rerun:target/failedScenarios.txt"}
        , monochrome = true, tags = {"@_sprint13,~@ignore"}
)
public class RunSprint13Test {
}
