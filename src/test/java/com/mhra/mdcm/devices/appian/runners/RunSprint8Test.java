...
@CucumberOptions(
        ...
        plugin = {"pretty", "html:target/cucumber-html-report", "json:target/sprint8_tests.json", "rerun:target/failedScenarios.txt"}
        , monochrome = true, tags = {"@_sprint8,~@ignore"}
)
public class RunSprint8Test {
}
