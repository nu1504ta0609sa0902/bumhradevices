...
@CucumberOptions(
        ...
        plugin = {"pretty", "html:target/cucumber-html-report", "json:target/sprint9_tests.json", "rerun:target/failedScenarios.txt"}
        , monochrome = true, tags = {"@_sprint9,~@ignore"}
)
public class RunSprint9Test {
}
