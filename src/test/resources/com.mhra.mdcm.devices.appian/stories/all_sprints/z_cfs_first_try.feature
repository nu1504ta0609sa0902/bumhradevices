Feature: As a UK based organisation I need to obtain a CERTIFICATE OF FREE SALE to export medical devices to non-EU countries
  ...
  Scenario Outline: Able to upload certificates with different notified body
    ...
    Examples:
      ...
      | manufacturerNoor | AccountST   | BSI              | Inspection Quality | General Medical Device             | Blood weighing scale | false      | Class2A            | true                 | ford,hyundai       |
      | manufacturerNoor | AccountST   | Amtac            | Batch Verification | General Medical Device             | Blood weighing scale | false      | Class2B            | true                 | ford,hyundai       |
      | manufacturerNoor | AccountST   | Amtac            | Design Exam        | General Medical Device             | Blood weighing scale | false      | Class3             | false                | ford,hyundai       |
      | manufacturerNoor | AccountST   | Lloyd            | Production Quality | Active Implantable Medical Devices | Desiccating chamber  | false      |                    |                      | ford,hyundai       |
      | manufacturerNoor | AccountST   | SGS              | Type Exam          | Active Implantable Medical Devices | Desiccating chamber  | false      |                    |                      | ford,hyundai       |
  ...
  Scenario Outline: Users can upload different types of CE Certificates
    ...
    Examples:
      ...
      | manufacturerNoor | AccountST   | pdf, jpg,png , tif ,docx | true       | true           | false       | Amtac        | General Medical Device | Blood weighing scale | false      | Class2B            | true                 | ford,hyundai       |
#      | authorisedRepNoor | AccountST   |   jpg      |true       | true           | false       | SGS          | Active Implantable Medical Devices | Desiccating chamber  | false      |                    |                      | ford,hyundai       |
  ...
  Scenario Outline: Verify certain elements are disable by defaults like Upload Certificate button
    ...
    Examples:
      ...
      | manufacturerNoor | AccountST   | false      |                |             | BSI          | General Medical Device             | Blood weighing scale | false      | Class2A            | true                 | ford,hyundai       |
  ...
  Scenario Outline: Verify removing all the added products should prevent us from moving to submit CFS application page
    ...
    Examples:
      | user             | searchTerm | addDevices | addCertificate | addProducts | notifiedBody | deviceType                         | gmdnDefinition      | customMade | riskClassification | relatedDeviceSterile | listOfProductNames |
      | manufacturerNoor | AccountST  | true       | true           | true        | SGS          | Active Implantable Medical Devices | Desiccating chamber | false      |                    |                      | ford,hyundai       |
  ...
  Scenario Outline: Error messages is displayed for incorrect date values
    ...
    Examples:
      ...
      | manufacturerNoor | AccountST   | According to this date your certificate has expired. MHRA cannot accept expired certificates. | -1                   | General Medical Device | BSI          | Blood weighing scale | false      | class3             | false                |
      | manufacturerNoor | AccountST   | According to this date your certificate has expired. MHRA cannot accept expired certificates. | 0                    | General Medical Device | BSI          | Blood weighing scale | false      | class2b            | false                |
#      | manufacturerNoor | AccountST   | This certificate expires within 3 months                                                     | 2                    | General Medical Device | BSI          | Blood weighing scale | false      | class2a            | false                |
  ...
  Scenario Outline: Error messages should be displayed to user for certain combinations
    ...
    Examples:
      ...
      | manufacturerNoor | AccountST   | This device must be registered with MHRA | General Medical Device             | Blood weighing scale | true       |                    |
      | manufacturerNoor | AccountST   | This device must be registered with MHRA | General Medical Device             | Blood weighing scale | false      | class1             |
      | manufacturerNoor | AccountST   | This device must be registered with MHRA | Active Implantable Medical Devices | Blood weighing scale | true       |                    |
      | manufacturerNoor | AccountST   | This device must be registered with MHRA | In Vitro Diagnostic Device         |                      |            |                    |
