Feature: Users should be able to add remove and edit for CFS new manufacturer application
  ...
  @5679 @1954 @5680 @5681 @_sprint20 @5593 @5665 @_sprint21 @5673 @5674 @_sprint22
  ...
  Scenario Outline: Business users should be able approve or reject individual devices for cfs new application
    ...
    And I click to "<approveOrReject>" selected devices
    Then All the device status should update to "<status>"
    Examples:
      | user              | approveOrReject | status   |
      | authorisedRepAuto | reject          | Rejected |
